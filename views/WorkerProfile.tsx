      ...
      <div className="relative h-[480px] w-full bg-glass overflow-hidden">
        ...
        <div className="fixed top-0 left-0 right-0 p-5 flex justify-between items-center z-40 pointer-events-none">
          <div className="pointer-events-auto">
            <button onClick={() => { window.history.back(); }} className="w-10 h-10 rounded-full bg-black/30 backdrop-blur-md flex items-center justify-center text-white border border-white/10 hover:bg-black/40 transition-colors">
              <BackIcon size={20} />
            </button>
          </div>
